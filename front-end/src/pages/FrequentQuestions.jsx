        ...
        <div className="col-12 col-md-10 col-lg-8">
          <Accordion defaultActiveKey="0" className="mt-3">
            ...
            <Accordion.Item eventKey="1">
              ...
              <Accordion.Body>
                Sangre Criolla ofrece garantía por cualquier defecto/anormalidad
                en su fabricación, no obstante, la garantía no cubre daños,
                roturas, cortes, desgastes, etc. causados por una incorrecta/
                irregular utilización y/o manipulación del cinturón
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="5">
              ...
              <Accordion.Body>
                ¡Ofertas imperdibles! en ventas al por mayor y/o a revendedores.
                Para mas información envíenos un correo a:
            ...
            <Accordion.Item eventKey="6">
              ...
              <Accordion.Body>
                ...
                coexistir de manera armoniosa con la naturaleza, el entorno y la
                comunidad. Somos activistas de una política ambiental basada en
                las tres «R»: RECICLADO, REUTILIZACIÓN Y REDUCCIÓN.
              </Accordion.Body>
            </Accordion.Item>
          </Accordion>
        </div>
